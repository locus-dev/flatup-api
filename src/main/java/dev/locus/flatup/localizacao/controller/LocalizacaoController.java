...
import locus.dev.flatup.localizacao.repository.LocalizacaoRepository;
...
public class LocalizacaoController {
	...
	// public ResponseEntity<Localizacao> salvarLocalizacao(@RequestBody @Valid
	...
	// public ResponseEntity<Localizacao> buscarLocalizacaoPorId(@PathVariable Long
	// id) throws Exception{
	...
	// public ResponseEntity<Localizacao> editarLocalizacaoPorId(@PathVariable("id")
	// Long id, @RequestBody @Valid Localizacao localizacao) throws Exception{
	...
	// Localizacao novoLocalizacao =
	// localizacaoRepository.save(opcionalLocalizacao);
	...
	// removerLocalizacaoPorId(@PathVariable Long id) throws Exception{
	// Localizacao localizacao = localizacaoRepository.getById(id);
	// if(localizacao == null) {
