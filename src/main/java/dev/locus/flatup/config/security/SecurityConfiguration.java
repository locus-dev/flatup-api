...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.OPTIONS, "/pessoa").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/endereco").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/imovel").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/locacao").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/localizacao").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/parceiro").permitAll()
